#-----------------------------------------------------------------------
# Purpose:     Database connectivity code
#-------------------------------------------------------------------------------

# Please do not run this code untill you are ready to really update (insert) the data to the database
while True:
    ...
    import sqlite3
    connection = sqlite3.connect('C:\Program Files\DB Browser for SQLite\Saved Database\Student.db')
